...
$env.PATH = ($env.PATH | append '/home/apoxu/.cargo/bin')
# add ~/.local/bin to path
$env.PATH = ($env.PATH | append '/home/apoxu/.local/bin')
# neovim(todo)
$env.PATH = ($env.PATH | append '/home/apoxu/.local/bin/bin')
...
alias la = ls -a
alias hx = helix
alias pon = overlay use proxy 
alias pof = overlay hide proxy
